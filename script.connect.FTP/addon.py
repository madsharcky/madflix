...
c.execute(""" INSERT INTO "main"."path" ("idPath", "strPath", "strContent", "strScraper", "strHash", "scanRecursive", "useFolderNames", "strSettings", "noUpdate", "exclude", "dateAdded", "idParentPath") VALUES ('3', 'ftp://"""+username+":"+pwd+"""@4k6qpf10oygosoxr.myfritz.net:990/Nur English/', 'movies', 'metadata.themoviedb.org', '', '2147483647', '1', '<settings version="2"><setting id="certprefix" default="true">Rated </setting><setting id="fanart">true</setting><setting id="imdbanyway" default="true">false</setting><setting id="keeporiginaltitle" default="true">false</setting><setting id="landscape" default="true">false</setting><setting id="language" default="true">en</setting><setting id="RatingS">IMDb</setting><setting id="tmdbcertcountry" default="true">us</setting><setting id="trailer">true</setting></settings>', '0', '0', '', '');""")
c.execute("""INSERT INTO "main"."path" ("idPath", "strPath", "strContent", "strScraper", "strHash", "scanRecursive", "useFolderNames", "strSettings", "noUpdate", "exclude", "dateAdded", "idParentPath") VALUES ('4', 'ftp://"""+username+":"+pwd+"""@4k6qpf10oygosoxr.myfritz.net:990/Serien/', 'tvshows', 'metadata.tvshows.themoviedb.org', '', '0', '0', '<settings version="2"><setting id="alsoimdb" default="true">false</setting><setting id="certprefix" default="true"></setting><setting id="fallback">true</setting><setting id="fanarttvart">true</setting><setting id="keeporiginaltitle" default="true">false</setting><setting id="language" default="true">en</setting><setting id="RatingS">IMDb</setting><setting id="titleprefix" default="true">Episode </setting><setting id="titlesuffix" default="true"></setting><setting id="tmdbart">true</setting><setting id="tmdbcertcountry" default="true">us</setting><setting id="tvdbwidebanners">true</setting></settings>', '0', '0', '', '');""")
conn.commit()
conn.close()